...
- All images used for hero image on each page and for the next race banner were downloaded from [Pexels](https://www.pexels.com).

- The images used for the pictures of participants in the gallery section and tutors in the workshop section were also downloaded from [Pexels](https://www.pexels.com).

- The images used for sign up and contact pages were also downloaded from [Pexels](https://www.pexels.com).

- All embedded videos are from [Youtube](https://www.youTube.com) (Pages – First cry parenting, The Girl With The Pilates Mat, Yoga with Adriene, VENTUNO YOGA) without their permissions.

- All embedded videos HTML code was generated by [Youtube](https://www.youTube.com).

- How to make an embedded YouTube video responsive was learnt from an article written on [Google Support](https://www.support.google.com).
